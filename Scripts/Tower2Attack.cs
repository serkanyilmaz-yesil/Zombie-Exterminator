...
{
    public static Tower2Attack tower2;
    ...
    private void AttackPlayer()
    {
        ...
        if (!alreadyAttacked)
        {
            ...
            CharMove.ctrl.placeindexBullet2--;
            if (CharMove.ctrl.placeindexBullet2 < 0)
            {
                CharMove.ctrl.placeindexBullet2 = 8;
                CharMove.ctrl.YAxisBullet2--;
            }
