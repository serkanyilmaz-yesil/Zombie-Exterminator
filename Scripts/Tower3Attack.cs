...
public class Tower3Attack : MonoBehaviour
{
    public static Tower3Attack tower3;
    ...
    private void AttackPlayer()
    {
        ...
        if (!alreadyAttacked)
        {
            ...
            CharMove.ctrl.placeindexBullet3--;
            if (CharMove.ctrl.placeindexBullet3 < 0)
            {
                CharMove.ctrl.placeindexBullet3 = 8;
                CharMove.ctrl.YAxisBullet3--;
            }
